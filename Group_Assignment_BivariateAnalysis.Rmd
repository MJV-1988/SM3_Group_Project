...
```{r PAY_x, echo=FALSE}
ggplot(aes(x=as.factor(`default payment next month`), y=PAY_0, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_0 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_0") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=PAY_2, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_2 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_2") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=PAY_3, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_3 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_3") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=PAY_4, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_4 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_4") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=PAY_5, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_5 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_5") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=PAY_6, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between PAY_6 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("PAY_6") + xlab("Default Payment Next Month")
...
ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT1, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT1 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT1") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT2, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT2 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT2") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT3, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT3 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT3") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT4, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT4 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT4") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT5, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT5 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT5") + xlab("Default Payment Next Month")

ggplot(aes(x=as.factor(`default payment next month`), y=BILL_AMT6, group=`default payment next month`),data=dat) + geom_boxplot() + ggtitle("Relationship between BILL_AMT6 and \n default payment next month") + theme(plot.title = element_text(hjust = 0.5)) + ylab("BILL_AMT6") + xlab("Default Payment Next Month")
```
