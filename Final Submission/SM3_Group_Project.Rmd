...
We now consider the relationship between the categorical predictor variables and the response variable. These will be explored using side-by-side box plots where appropriate, otherwise analyzing the mean values.
...
```{r correlation, echo=FALSE, fig.height=4, fig.width=5}
